...
//        }
        ...
        */
        ...
        private static void GetSplinePoint2D(ref UnityEngine.Vector3 point1, ref UnityEngine.Vector3 point2, ref UnityEngine.Vector3 point3, ref UnityEngine.Vector3 point4, float t, out UnityEngine.Vector3 point)
        {
            ...
            point = new UnityEngine.Vector3(CalculatePolynomial(ref polynomialX, t), CalculatePolynomial(ref polynomialY, t), 0.0f);
        }

        private static void GetSplinePoint3D(ref UnityEngine.Vector3 point1, ref UnityEngine.Vector3 point2, ref UnityEngine.Vector3 point3, ref UnityEngine.Vector3 point4, float t, out Vector3 point)
        {
        ...
        public static bool CreateSpline(ICollection<Vector3> path, IList<Vector3> points, int numberOfSegments, bool closePath)
        {
            ...
            float start = 0.0f;
            UnityEngine.Vector3 point, previousPoint, currentPoint, nextPoint, nextNextPoint;
        ...
        /// <param name="closePath">True to loop back to the start, false otherwise</param>
        /// <returns>True if success, false if points length is too small</returns>
        public static bool CreateSplineWithSegmentDistance(ICollection<UnityEngine.Vector3> path, IList<UnityEngine.Vector3> points, float distancePerSegment, bool closePath)
        {
